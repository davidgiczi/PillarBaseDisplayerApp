...
public class PillarMeasDataFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.calcPillarLocationData.setOrdinate_distance(fragmentMeasDataBinding.ordinateDistanceOfNewPillar.getText().toString());
            ...
            MainActivity.MEAS_PILLAR_DATA = new String[18];
            ...
            MainActivity.MEAS_PILLAR_DATA[16] = fragmentMeasDataBinding.abscissaDistanceOfNewPillar.getText().toString();
            MainActivity.MEAS_PILLAR_DATA[17] = fragmentMeasDataBinding.ordinateDistanceOfNewPillar.getText().toString();
    ...
    private void setMeasPillarData(){
        ...
        if( MainActivity.MEAS_PILLAR_DATA != null ){
            ...
            fragmentMeasDataBinding.abscissaDistanceOfNewPillar.setText(MainActivity.MEAS_PILLAR_DATA[16]);
            fragmentMeasDataBinding.ordinateDistanceOfNewPillar.setText(MainActivity.MEAS_PILLAR_DATA[17]);
        }
    }
